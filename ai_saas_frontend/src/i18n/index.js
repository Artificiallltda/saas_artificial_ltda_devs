...
export const backendMessageKeyMap = {
  ...
  "Acesso restrito ao administrador responsável ": "errors.admin_only",
  "Email já cadastrado": "errors.email_already_used",
  "Username já existe": "errors.username_already_used",
  "Email não verificado": "errors.email_not_verified",
  "Senha fraca": "errors.weak_password",
  ...
  "Geração de Vídeo": "subscription.features.video_generation",
  "Freepik/Envato Artificiall": "subscription.features.download_bot",
